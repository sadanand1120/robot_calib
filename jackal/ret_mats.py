...
def get_cam_int_dict(override_intrinsics_filepath=None):
    if override_intrinsics_filepath is None:
        intrinsics_filepath = os.path.join(os.path.dirname(os.path.realpath(__file__)), "params/zed_left_rect_intrinsics.yaml")
    else:
